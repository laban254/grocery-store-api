...
class Command(BaseCommand):
    ...
    def create_customers(self):
        ...
        customers_data = [
            {
                ...
                "phone": "0712345678",
                "address": "123 Kenyatta Avenue, CBD, Nairobi, Kenya",
            },
            {
                "first_name": "Wanjiku",
                "last_name": "Muthoni",
                ...
                "phone": "0723456789",
                "address": "456 Moi Avenue, CBD, Nairobi, Kenya",
            },
            {
                "first_name": "Otieno",
                "last_name": "Odhiambo",
                ...
                "phone": "0734567890",
                "address": "789 Ngong Road, Kilimani, Nairobi, Kenya",
            },
            {
                "first_name": "Akinyi",
                "last_name": "Atieno",
                "email": "akinyi.atieno@example.com",
                "phone": "0745678901",
                "address": "101 Kimathi Street, CBD, Nairobi, Kenya",
            },
            {
                "first_name": "Kipchoge",
                "last_name": "Keino",
                "email": "kipchoge.keino@example.com",
                "phone": "0756789012",
                "address": "202 Waiyaki Way, Westlands, Nairobi, Kenya",
            },
        ]
        ...
        customer_count = User.objects.exclude(is_staff=True).exclude(is_superuser=True).count()
                ...
                products_data.append(
                    {
                        ...
                        "slug": slugify(name),
                        "category": category,
                        "description": f"A quality {name.lower()} from {category.name} category.",
                        "price": price,
                        "stock": stock,
                    }
                )
    ...
    def create_orders(self):
        ...
        if not customers or not products:
            self.stdout.write(
                self.style.WARNING("No customers or products available to create orders")
            )
            return
        ...
        self.stdout.write(
            self.style.SUCCESS(
                self.style.SUCCESS(f"Created {orders_count} orders with {items_count} items")
            )
        )
